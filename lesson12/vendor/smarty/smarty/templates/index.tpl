        ...
        <div class="col-xs-12 col-lg-8 col-lg-offset-2">
            <form method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="seller_name" class="form-control" id="name" placeholder="Имя" value="{if isset($ad)}{$ad->getSellerName()}{/if}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="allow_mails" {if isset($ad) && $ad->getAllowMails() eq 'yes'} checked="" {/if}> Я не хочу получать вопросы по объявлению по e-mail
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select name="city_id" class="form-control" id="cities">
                            ...
                            {html_options options = $cities selected = (isset($ad)) ? $ad->getCityId() : null}
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                        ...
                        <select name="category_id" class="form-control" id="categories">
                            ...
                            {foreach from = $cats item = parent_cat}
                                <optgroup label="{$parent_cat.0}">
                                    {html_options options = $parent_cat.sub selected = (isset($ad)) ? $ad->getCategoryId() : null}
                                </optgroup>
                            {/foreach}
                        </select>
                    </div>
