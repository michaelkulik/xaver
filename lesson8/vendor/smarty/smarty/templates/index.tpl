            ...
            <form method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="radio">
                            <label>
                                <input type="radio" name="private" value="option1" {if isset($ad.private) && $ad.private eq 'option1'} checked="" {/if}>
                                Частное лицо
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="private" value="option2" {if isset($ad.private) && $ad.private eq 'option2'} checked="" {/if}>
                                Компания
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="allow_mails" {if isset($ad.allow_mails)} checked="" {/if}> Я не хочу получать вопросы по объявлению по e-mail
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="price" class="form-control" id="price" placeholder="0" value="{if isset($ad.price)}{$ad.price}{/if}">
                    </div>
    ...
    <div class="row">
        <div class="col-xs-12 col-lg-8 col-lg-offset-2">
            ...
            <table class="table">
                ...
                {foreach from = $ads key = id item = ad}
                    <tr>
