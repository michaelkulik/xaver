<?php /* Smarty version 2.6.25-dev, created on 2016-06-17 18:30:18
...
?>
                                <optgroup label="<?php echo $this->_tpl_vars['parent_cat']['name']; ?>
">
                                    <?php $_from = $this->_tpl_vars['parent_cat']['childNodes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['child']):
?>
                                        <option <?php if ($this->_tpl_vars['key'] == $this->_tpl_vars['ad']['category_id']): ?>selected=""<?php endif; ?> value="<?php echo $this->_tpl_vars['key']; ?>
