<?php /* Smarty version 2.6.25-dev, created on 2016-05-30 12:42:39
            ...
            <form method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="radio">
                            <label>
                                <input type="radio" name="private" value="option1" <?php if (isset ( $this->_tpl_vars['ad']['private'] ) && $this->_tpl_vars['ad']['private'] == 'option1'): ?> checked="" <?php endif; ?>>
                                Частное лицо
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="private" value="option2" <?php if (isset ( $this->_tpl_vars['ad']['private'] ) && $this->_tpl_vars['ad']['private'] == 'option2'): ?> checked="" <?php endif; ?>>
                                Компания
                            </label>
                        </div>
                    </div>
...
<?php endif; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="allow_mails" <?php if (isset ( $this->_tpl_vars['ad']['allow_mails'] )): ?> checked="" <?php endif; ?>> Я не хочу получать вопросы по объявлению по e-mail
                            </label>
                        </div>
                    </div>
                </div>
...
<?php endif; ?></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="price" class="form-control" id="price" placeholder="0" value="<?php if (isset ( $this->_tpl_vars['ad']['price'] )): ?><?php echo $this->_tpl_vars['ad']['price']; ?>
<?php endif; ?>">
                    </div>
...
'><?php echo $this->_tpl_vars['ad']['title']; ?>
                        ...
                        <td><a href='#' data-href='?delete=<?php echo $this->_tpl_vars['id']; ?>
