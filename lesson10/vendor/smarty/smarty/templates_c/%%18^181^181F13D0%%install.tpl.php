<?php /* Smarty version 2.6.25-dev, created on 2016-06-16 18:26:32
...
<div class="container">
    <div class="row" style="margin-top: 10px;">
        <div class="col-xs-12 col-lg-8 col-lg-offset-2">
            <style>
                label:not(.exception)::after {
                    color: red; content: " *";
                }
            </style>
            <?php if (isset ( $this->_tpl_vars['success'] ) & ! isset ( $this->_tpl_vars['error'] )): ?>
                <div class="col-xs-12">
            ...
            <?php else: ?>
                ...
                <form method="post">
                    ...
                    <div class="form-group row">
                        <label for="password" class="col-sm-4 form-control-label exception">Пароль</label>
                        <div class="col-sm-8">
